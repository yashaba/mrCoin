...
export class ContactService {
  ...
  public loadContacts(filterBy = null) {
    let contacts = utils.loadFromStorage('contacts') || this._contacts;
    if (filterBy && filterBy.term) {
      contacts = this._filter(filterBy.term, contacts)
    }
    this._contacts$.next(this._sort(contacts))
    this.contacts$.subscribe(contacts => utils.storeToStorage('contacts', contacts))
  ...
  public getContactById(id: string): Observable<Contact> {
    ...
    console.log('contact in sertice from  id', contact);
